    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/gym/editor/multiplePhotoUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/gym/editor/photoUpload',	// 파일 업로드시 동작되는 컨트롤러 URL
 	        sCallback : '/gym/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
